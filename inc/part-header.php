<div class="header-container container p-3">
    <div class="row text-center align-items-center py-0 m-0">
        ...
        <div class="col-md-4 p-0">
            <h5 class="colortheme fw-bold">Hotline : <?php echo get_theme_mod('hotline'); ?></h5>
        </div>
...
<nav id="main-navi" class="navbar navbar-expand-md d-block navbar-light  bg-theme p-0" aria-labelledby="main-nav-label">
    ...
    <div class="menu-styles bg-theme">
        <div class="pb-0">
            <div class="offcanvas offcanvas-start bg-theme" tabindex="-1" id="navbarNavOffcanvas">
                ...
                wp_nav_menu(
                    array(
                        ...
                        'container_id'    => '',
                        'menu_class'      => 'navbar-nav navbar-dark justify-content-md-start justify-content-start flex-md-wrap flex-grow-1',
                        'fallback_cb'     => '',
